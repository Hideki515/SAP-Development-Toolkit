...
*&---------------------------------------------------------------------*
TYPES:
  BEGIN OF y_sflight, "Definição da estrutura da tabela
...
*&---------------------------------------------------------------------*
DATA:
  t_sflight TYPE STANDARD TABLE OF y_sflight. "Definição da tabela interna.
...
FORM zf_selecao_dados .
  ...
  FREE: t_sflight. "Limpa a tabela interna antes da seleção para evitar lixinho.
